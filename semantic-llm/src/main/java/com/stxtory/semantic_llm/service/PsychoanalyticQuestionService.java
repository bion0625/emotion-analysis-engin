...
public class PsychoanalyticQuestionService {
    ...
    public String generateQuestion(String userText) {
        String systemMessage = """
            ...
            **당신의 유일한 임무는 사용자에게 자기 성찰을 유도하는 단 하나의 질문을 한국어로 생성하는 것입니다.**
            **질문 외의 다른 어떤 내용도 출력해서는 안 됩니다.**

            사용자의 글을 깊이 있게 분석하고, 정신분석학적 관점(예: 무의식, 방어 기제, 유년기 경험, 관계 패턴, 내면의 갈등, 숨겨진 동기, 투사 등)에서 핵심을 파악합니다.

            **아래의 엄격한 출력 규칙을 따르세요:**
            1.  **결과물은 오직 하나의 질문이어야 합니다.**
            2.  **질문은 반드시 한국어여야 합니다.**
            3.  **질문 앞이나 뒤에 어떠한 서론, 설명, 분석, 문장도 추가하지 않습니다.** (예: "Here is a question:", "Based on...", "Psychological Analysis:" 등 절대 사용 금지)
            4.  질문은 간결하고, 직접적이며, 일상적인 언어를 사용합니다. 전문 용어 사용을 금지합니다.
            5.  질문 끝에는 반드시 물음표(?)를 붙입니다.
            ...
            **질문 예시:**
            ...
            ---
            **오직 질문만을 한국어로 출력하세요. 다른 어떤 설명도 붙이지 마세요.**
            ---
            """;
